...
for t = 2:tend
    ...
    for i = 1:n
        ...
        %if t == 55 || t == 205 || t == 355 || t == 505 || t == 655 || t == 805
        % BA if t == 250 || t == 400 || t == 550 || t == 700 || t == 850 || t == 1000
        if t == 85 || t == 235 || t == 385 || t == 535 || t == 685 || t == 835
            if (S(t-1,i) == 0) && (rand<f)
                infected = [infected i];
            end
        end
...
sum_S = sum_S + S;
%BOUNCE(J) = yy(1000)-yy(999);
%ADDTRANS(J) = yy(1150)-yy(999);
end
