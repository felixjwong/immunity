...
%% Overall loop for independent simulations
for J = 1:10 % 10 independent simulations
num_infected = [];
...
%% Main loop for transmission dynamics
for t = 2:tend
    exposed = [];
    infected = [];
    recovered = [];
...
% NUM_INF is the matrix of all cumulative infections across all simulations
